  ...
  const handleTranslate = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/translate`, {
        ...
        body: JSON.stringify({ text, chained: chainedMode }),
      });
    ...
    <div className="page">
      ...
      <main className="layout">
          ...
          <form onSubmit={handleTranslate}>
            ...
            <label className="chain-toggle">
              <input
                type="checkbox"
                checked={chainedMode}
                onChange={e => setChainedMode(e.target.checked)}
              />
              Kettenmodus — Wörter aus mehreren Segmenten verketten
            </label>
          </form>
        ...
        <section className="panel animation-panel">
          ...
          {motion ? (
            <>
              <SkeletonViewer3D motion={motion} />
              <p className="muted" style={{ marginTop: "0.5rem" }}>
